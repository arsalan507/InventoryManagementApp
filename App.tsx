...
const [orderDate, setOrderDate] = useState(today);
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <TextInput placeholder="Supplier Name" style={styles.input} value={supplier} onChangeText={setSupplier} />
      <TextInput placeholder="Order Date (YYYY-MM-DD)" style={styles.input} value={orderDate} onChangeText={setOrderDate} />
...
const styles = StyleSheet.create({
  container: {
  flexGrow: 1,
  backgroundColor: '#f4f4f4', // Light grey or any color you prefer
  padding: 20,
  paddingBottom: 100,
  alignItems: 'center',
},
